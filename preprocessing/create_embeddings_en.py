...
index = 0
for data, rel_data in zip(en_data, en_rel_data):
    meta_ = {}
...
print("saving...")
with open("data/embeddings/entities_embeddings_dbp15k_en.pkl", "wb") as f:
...
print("saving...")
with open("data/embeddings/attributes_embeddings_dbp15k_en.pkl", "wb") as f:
...
print("saving...")
with open("data/embeddings/values_embeddings_dbp15k_en.pkl", "wb") as f:
...
print("saving...")
with open("data/embeddings/relationships_embeddings_dbp15k_en.pkl", "wb") as f:
    torch.save(relationships_embeddings, f)

# Save metadata
json.dump(meta_data, open("data/embeddings/meta_data_dbp15k_en.json", "w"), indent=2)
